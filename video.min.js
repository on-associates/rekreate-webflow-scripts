      ...
      try {
            ...
            output(t) {
              createImageBitmap(t, { resizeQuality: "low" })
                ...
                .catch((error) => {
                  ...
                  // Continue decoding even if error occurs
                });
            },
            error(t) {
              console.error(t);
        ...
        fetch(t)
          .then((t) => {
            ...
            return e
              .read()
              .then(function t({ done: s, value: r }) {
                if (s) {
                  o.flush();
                  return null;
                }
                let n = r.buffer;
                (n.fileStart = i), (i += n.byteLength), o.appendBuffer(n);
                return e.read().then(t);
              })
              .catch((error) => {
                console.error("Fetching video data failed:", error);
                a(error);
              });
          })
          .catch((error) => {
